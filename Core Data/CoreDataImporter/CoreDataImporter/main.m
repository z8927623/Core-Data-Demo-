...
int main(int argc, const char * argv[])
{
    ...
    @autoreleasepool {
        ...
        NSArray *jsonBanks = [NSJSONSerialization JSONObjectWithData:[NSData dataWithContentsOfFile:dataPath] options:kNilOptions error:&err];
        
//        NSLog(@"Import Banks: %@", jsonBanks);
        ...
        [jsonBanks enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            ...
            failedBankDetails.closeDate = [formatter dateFromString:[obj objectForKey:@"closeDate"]];
            failedBankDetails.updateDate = [formatter dateFromString:[obj objectForKey:@"updateDate"]];
